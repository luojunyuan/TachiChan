...
xml_files=("TouchChan/TouchChan.csproj" 
    ...
    "TouchChan.AssistiveTouch.Gamepad/TouchChan.AssistiveTouch.Gamepad.csproj"
)
for xml_file in "${xml_files[@]}"; do
    sed -i '' -e 's|<TargetFramework>.*</TargetFramework>|<TargetFramework>net472</TargetFramework>|' "$xml_file"
done
...
dotnet build -c Release -o bin/TachiChan TouchChan.AssistiveTouch.Gamepad/TouchChan.AssistiveTouch.Gamepad.csproj
...
tar -czf bin/net472.tar.gz -C bin/TachiChan .
